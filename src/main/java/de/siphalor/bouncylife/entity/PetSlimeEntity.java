...
public class PetSlimeEntity extends TameableEntity implements JumpingMount {
	...
	public boolean handleFallDamage(float fallDistance, float damageMultiplier) {
		...
		return super.handleFallDamage(fallDistance, damageMultiplier * 0.2F);
	}
	...
	static class AttackGoal extends MeleeAttackGoal {
		...
		protected void attack(LivingEntity target, double squaredDistance) {
			...
			if (squaredDistance <= d && method_28347()) {
	...
	public static class CombineWithMateGoal extends Goal {
		...
		protected final TargetPredicate targetPredicate = new TargetPredicate().includeInvulnerable().includeTeammates().includeHidden().setBaseMaxDistance(10D);
